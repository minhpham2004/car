    ...
    return (
        <div>
            ...
            <div className="billing_info">
                {/* <h2>{carDataRedux}</h2> */}
                <h2 className='billing-info_text'>New Car Info</h2>
                <h4 className='billing-info_alert'>Please enter your car info</h4>
...
// Logic edit items:
// const index = findIndex(el => el.id === ...)
// CarsData[index] = {updateObj}
